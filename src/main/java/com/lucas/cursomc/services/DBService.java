...
import com.lucas.cursomc.domain.*;
...
import com.lucas.cursomc.repositories.*;
...
public class DBService {
    ...
    public void instantiateDatabase() throws ParseException {
        ...
        Categoria cat3 = new Categoria(null, "Camam mesa e banho");
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "lucas_trigueiro10@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Ana Costa", "lucashtrigueiro@gmail.com", "13359201027", TipoCliente.PESSOAFISICA, pe.encode("123"));
